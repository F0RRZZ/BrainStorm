...
class CollaborationRequestFormView(django.views.generic.FormView, django.contrib.auth.mixins.LoginRequiredMixin,):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["project"] = django.shortcuts.get_object_or_404(
            projects.models.Project.objects.only(projects.models.Project.name.field.name),
...
class CollaborationRequestListView(django.views.generic.ListView, django.contrib.auth.mixins.LoginRequiredMixin,):
    template_name = 'collaboration/request_list.html'
    context_object_name = 'requests'
    pk_url_kwarg = 'project_id'

    def get_queryset(self):
        return collaboration.models.CollaborationRequest.objects.get_for_project(
            self.kwargs[self.pk_url_kwarg],
        )


class CollaborationRequestDetailView(django.views.generic.DetailView, django.contrib.auth.mixins.LoginRequiredMixin,):
